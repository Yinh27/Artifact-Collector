...
acq_scripts = {
	...
	"volatility_analysis": [
        ...
        r"EXE:&VR2 -f &VR1 windows.pslist.PsList --exestdout=&acn\VoLoki\PSList.dat",
        "Say:",
        "Say:[+] Parsing Process Tree...",
        r"EXE:&VR2 -f &VR1 windows.pstree.PsTree --exestdout=&acn\VoLoki\PSTree.dat",
        "Say:",
        "Say:[+] Parsing Complete Process Scan (Unlinked Processes)...",
        r"EXE:&VR2 -f &VR1 windows.psscan.PsScan --exestdout=&acn\VoLoki\PSScan.dat",
        "Say:",
        "Say:[+] Parsing Modules...",
        r"EXE:&VR2 -f &VR1 windows.modules.Modules --exestdout=&acn\VoLoki\Modules.dat",
        "Say:",
        "Say:[+] Parsing Complete Module Scan (Unlinked Modules)...",
        r"EXE:&VR2 -f &VR1 windows.modscan.ModScan --exestdout=&acn\VoLoki\ModScan.dat",
        "Say:",
        "Say:[+] Parsing Complete Driver Scan...",
        r"EXE:&VR2 -f &VR1 windows.driverscan.DriverScan --exestdout=&acn\VoLoki\DriverScan.dat",
        "Say:",
        "Say:[+] Parsing Complete Services Scan...",
        r"EXE:&VR2 -f &VR1 windows.getservicesids.GetServiceSIDs --exestdout=&acn\VoLoki\SvcScan.dat",
        "Say:",
        "Say:[+] Parsing Command Line History...",
        r"EXE:&VR2 -f &VR1 windows.cmdline.CmdLine --exestdout=&acn\VoLoki\CmdLine.dat",
        "Say:",
        "Say:[+] Parsing Network Info...",
        r"EXE:&VR2 -f &VR1 windows.netscan.NetScan --exestdout=&acn\VoLoki\Netscan.dat",
        "Say:",
        "Say:[+] Parsing Open Files Info...",
        r"EXE:&VR2 -f &VR1 windows.filescan.FileScan --exestdout=&acn\VoLoki\OpenFiles.dat",
        "Say:",
        "Say:[+] Creating Process List CSV for Module Processing...",
        r"EXE:&VR2 -r csv -f &VR1 windows.pslist.PsList --exestdout=&acn\VoLoki\PSList.csv",
        "SAY: I'm Done!"
    ],
    "prefetch": [
        "VER:Windows",
    ...
    "recent_lnk": [
        ...
        "Say:",
        r"EXE:&VR2 -f &VR1 -o &VR1\parsed_lnk.csv",
        "SAY: I'm Done!"
    ],
    "wmi_database": [
        "SAY:",
    ...
    "bmc": [
        ...
        "SAY:",
        r"VR2:.\SYS\pycode\bmc-tools.exe",
        "CKN:&VR2",
        "Say:",
        ...
        r"ACQ:\BMC_Results",
        r"EXE:&VR2 -s &VR3 -d &Acq",
        "SAY: I'm Done!"
    ],
    "hash": [
        r"VR2:.\SYS\pycode\hash.exe",
        "CKN:&VR2",
        "Say:",
        ...
        "Say:",
        r"EXE:&VR2 -f &VR1 -o &VR1\hash.txt",
        "SAY: I'm Done!"
    ]
}
